...
function renderCart(){
    const cartArea = document.querySelector(".cart-table")
    ...
    cartData.carts.forEach(i=>{
        ...
        <div class="col name">
            ...
            <div class="item-name">${i.product.title} </div>
        </div>
        <div class="col singel-price">NT$${i.product.price}</div>
        <div class="col quantity"><input class="cart-product-quantity" type="number" data-id="${i.id}" value="${i.quantity}"></input></div>
        <div class="col price">NT$${singleTotalPrice}</div>
        <div class="col del-btn"><i class="fas fa-times del-btn" data-id="${i.id}"></i></div>
    </div>
        `
    })
